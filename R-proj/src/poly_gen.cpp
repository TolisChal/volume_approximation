...
Rcpp::NumericMatrix poly_gen (int kind_gen, bool Vpoly_gen, bool Zono_gen, int dim_gen, int m_gen) {
    ...
    if (Zono_gen) {
        ...
        switch (kind_gen) {
            ...
            case 6:
                return extractMatPoly(dual_knapsack<Vpolytope, RNGType>(dim_gen));

            case 7:
                return extractMatPoly(everest<Vpolytope>(dim_gen, m_gen));
        ...
        switch (kind_gen) {
            ...
            case 7:
                return extractMatPoly(gen_birk<Hpolytope>(dim_gen, false));
