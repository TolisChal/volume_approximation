...
#include "test_vol2/test_cartesian_kernel2.h"
#include "test_vol2/test_vars2.h"
#include "test_vol2/test_hpolytope2.h"
#include "test_vol2/test_ball2.h"
#include "test_vol2/test_ballintersectconvex2.h"
//#include "rounding.h"
#include "test_vol2/test_samplers2.h"
#include "test_vol2/test_ball_annealing2.h"
#include "test_vol2/test_ratio_estimation2.h"
#include "test_vol2/test_cooling_balls2.h"
#include "test_vol2/test_high_cool_vol2.h"
...
Rcpp::NumericVector test_generic_volume(Polytope& P, unsigned int walk_step, double e,
                      ...
                      bool rdhr, bool billiard, double diam, bool rounding, int type, bool verbose, bool log_length, int bref) {
...
//' @export
// [[Rcpp::export]]
Rcpp::NumericVector test_volume2 (Rcpp::Reference P,  Rcpp::Nullable<unsigned int> walk_length = R_NilValue,
    ...
    unsigned int win_len = 170, N = 500 * 2 +  n * n / 2, NN = 125, nu = 10, bref = 10*n;
    ...
    if(parameters.isNotNull()) {
        ...
        if (Rcpp::as<Rcpp::List>(parameters).containsElementNamed("bref")) {
            bref = Rcpp::as<int>(Rcpp::as<Rcpp::List>(parameters)["bref"]);
        }
