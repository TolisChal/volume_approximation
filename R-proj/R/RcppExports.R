...
test_high_rounding <- function(P, method = NULL, seed = NULL) {
    .Call(`_volesti_test_high_rounding`, P, method, seed)
}
...
#' vol = volume(Z, random_walk = "RDHR", walk_length = 5)
#' @export
test_volume2 <- function(P, walk_length = NULL, error = NULL, inner_ball = NULL, algo = NULL, random_walk = NULL, rounding = NULL, parameters = NULL) {
    .Call(`_volesti_test_volume2`, P, walk_length, error, inner_ball, algo, random_walk, rounding, parameters)
}
