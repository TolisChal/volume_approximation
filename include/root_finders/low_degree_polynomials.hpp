...
#ifndef LOW_DEGREE_POLYNOMIALS_HPP
#define LOW_DEGREE_POLYNOMIALS_HPP
...
int SolveP3(std::vector<double> &x, double a, double b, double c) {	// solve cubic equation x^3 + a*x^2 + b*x + c = 0
	double a2 = a*a;
    double q  = (a2 - 3*b)/9; 
